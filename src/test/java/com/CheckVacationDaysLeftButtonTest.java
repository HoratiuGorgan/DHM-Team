...
public class CheckVacationDaysLeftButtonTest {
	...
	// this test checks if the blue button from 'New Vacations Request', showing
	// the vacations days left works correctly(days are substracted accordingly
	// after a vacation request)
